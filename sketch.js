...
if(eCell==true) {
    ...
    //cordas
    corda1 = new Rope(7, { x: width / 3, y: height / 9 });
    corda2 = new Rope(7, { x: width / 1.5, y: height / 3});
    corda3 = new Rope(7, { x: width /6, y: height / 3.5});
    ...
    coelho = createSprite(width / 1.9, height - 72, 50, 50);
